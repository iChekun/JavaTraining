...
public class TripComparatorByCostTest {

    private TripComparatorByCost comparator = new TripComparatorByCost();
    private static Logger logger = Logger.getLogger(TripComparatorByCostTest.class);

    @BeforeClass
    public static void beforeClass() {
        Configure.getInstance().configuration();
        logger.info("TripComparatorByCostTest started!");
    }
    ...
    public static void afterClass() {
        logger.info("TripComparatorByCostTest finished!");
    }
