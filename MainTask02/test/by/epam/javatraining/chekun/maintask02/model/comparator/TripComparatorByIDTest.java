...
public class TripComparatorByIDTest {

    private TripComparatorByID comparator = new TripComparatorByID();
    private static Logger logger = Logger.getLogger(TripComparatorByIDTest.class);

    @BeforeClass
    public static void beforeClass() {
        Configuration.getInstance().configuration();
        logger.info("TripComparatorByIDTest started!");
    }
    ...
    public static void afterClass() {
        logger.info("TripComparatorByIDTest finished!");
    }
}