...
public class TripComparatorByTransportTypeTest {

    private TripComparatorByTransportType comparator = new TripComparatorByTransportType();
    private static Logger logger = Logger.getLogger(TripComparatorByTransportTypeTest.class);

    @BeforeClass
    public static void beforeClass() {
        Configuration.getInstance().configuration();
        logger.info("TripComparatorByTransportTypeTest started!");
    }
    ...
    public static void afterClass() {
        logger.info("TripComparatorByTransportTypeTest finished!");
    }
