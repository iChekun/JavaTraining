...
public class TripComparatorByDateTest {

    private TripComparatorByDate comparator = new TripComparatorByDate();
    private static Logger logger = Logger.getLogger(TripComparatorByDateTest.class);

    @BeforeClass
    public static void beforeClass() {
        Configure.getInstance().configuration();
        logger.info("TripComparatorByDateTest started!");
    }
    ...
    public static void afterClass() {
        logger.info("TripComparatorByDateTest finished!");
    }
