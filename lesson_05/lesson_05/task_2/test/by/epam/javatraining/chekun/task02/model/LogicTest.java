...
public class LogicTest {
    ...
    @Test
    public void testIsVowelEnglish2_true() {

        char symbol = 'A';

        assertTrue(Logic.isVowelEnglish2(symbol));
    }

    @Test
    public void testIsVowelEnglish2_false() {

        char symbol = 'b';

        assertFalse(Logic.isVowelEnglish2(symbol));
    }


    @Test
    public void testIsVowelEnglishUpperCase2_true() {
